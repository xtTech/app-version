...
include::src/main/asciidoc/_chapter/get-started.adoc[Get started]

include::src/main/asciidoc/_chapter/user-manual.adoc[使用手册]

include::src/main/asciidoc/_chapter/rest-manual.adoc[版本查询接口]
